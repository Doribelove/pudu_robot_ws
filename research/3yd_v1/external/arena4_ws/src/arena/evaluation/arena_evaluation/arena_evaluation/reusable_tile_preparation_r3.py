...
from .coarse_endpoint_cover_r3 import candidate_tiles, VERSION as SELECTION_VERSION
...
class ReusableTileTopology(TiledTopology):
    ...
    def candidate_tiles(self,start,goal,endpoint_radius_m=25.,*,deadline=None):
        return candidate_tiles(self,start,goal,endpoint_radius_m,deadline=deadline)
